...
def news_detail(request,rid):
    ...
    shownews = News.objects.filter(pk=rid)#---------------
    ...
    code = News.objects.get(pk=rid).pk  ## For Commnet Section
    ...
    link = "/urls/" + str(News.objects.get(pk=rid).rand)  ## For QR Code
